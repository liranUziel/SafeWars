		...
		>
			<div className={`flex justify-end gap-2`} id='header'>
				{safe.solved ? (
					...
					<BsFillArrowDownCircleFill onClick={downloadSafe} className={`hover:text-green-600`} />
				)}
			...
			<div className={`flex justify-center my-5 items-center`} id='main'>
				{safe.solved ? <RiSafe2Fill className={`text-7xl z-0`} /> : <BsSafe className={`text-7xl z-0`} />}
				<button
			...
			<div id='footer'>
				<h3 className=''>
					Safe name: <span className=''>{name}</span>
				</h3>
