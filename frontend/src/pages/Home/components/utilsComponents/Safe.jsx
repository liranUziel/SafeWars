  ...
  return (
    ...
    >
      ...
      <div className={`flex justify-center my-5 items-center`} id="main">
        ...
        {/* <button className="z-10 text-xl font-semibold p-2 bg-green-500 rounded w-fit h-9" id={safe._id} onClick={breakSafe}></button>     */}
      </div>
      <div id="footer">
        <h3 className="">
      ...
      >
        <ModalOverlay />
        <ModalContent>
          <ModalHeader>Breaking a safe</ModalHeader>
          <ModalCloseButton />
          <ModalBody>
